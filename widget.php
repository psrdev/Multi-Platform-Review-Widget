    ...
    <div id="mprw-widget" class="mprw-widget bottom-right">
        <div class="mprw-widget-button">
            ...
            <ul class="mprw-widget-platforms">
                <li><a href="<?php echo esc_url($options['platforms']['google']['link'] ?? '#'); ?>" target="_blank"><img
                            src="<?php echo MPRW_PLUGIN_URL . "assets/google.svg" ?>" alt="Google" width="30px"
                            height="30px"></a></li>
                <li><a href="<?php echo esc_url($options['platforms']['facebook']['link'] ?? '#'); ?>" target="_blank"><img
                            src="<?php echo MPRW_PLUGIN_URL . "assets/facebook.svg" ?>" alt="Facebook" width="30px"
                            height="30px"></a></li>
                <li><a href="<?php echo esc_url($options['platforms']['tripadvisor']['link'] ?? '#'); ?>"
                        target="_blank"><img src="<?php echo MPRW_PLUGIN_URL . "assets/tripadvisor.svg" ?>"
                            alt="Tripadvisor" width="30px" height="30px"></a></li>
                <li><a href="<?php echo esc_url($options['platforms']['trustpilot']['link'] ?? '#'); ?>"
                        target="_blank"><img src="<?php echo MPRW_PLUGIN_URL . "assets/trustpilot.svg" ?>" alt="Trustpilot"
